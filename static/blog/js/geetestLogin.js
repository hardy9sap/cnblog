$(function () {
    ...
    var handlerPopup = function (captchaObj) {
        captchaObj.onSuccess(function (event) {
            // setTimeout(function () {
            //     myModal.modal("show");
            // }, 2000);
        ...
        $("#id_btn_login").click(function (event) {
            ...
            // 3. 检测验证码是否为空
            if (!checkCode.val()) {
                add(divCheckCodeFormGroup, hasError);
                remove(spanFormGroupSub, hidden);
                addEvent(inputFormGroupSub, "input", function () {
                    remove(divCheckCodeFormGroup, hasError);
                    add(spanFormGroupSub, hidden);
                });
        ...
        captchaObj.appendTo("#id_popup_captcha")
    };
